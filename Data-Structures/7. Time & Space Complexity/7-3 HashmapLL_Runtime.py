from etc.hashmap import HashMap
...
while my_linked_list.head_node.value[0] != "Zachary":
  my_linked_list.head_node = my_linked_list.head_node.next_node
linked_list_zachary_disease = my_linked_list.head_node.value[1] 
