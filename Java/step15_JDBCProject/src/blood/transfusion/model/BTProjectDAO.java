...
public class BTProjectDAO {
	...
	// 프로젝트 아이디로 btContent 수정
	public static boolean updateBTProjectContent(String btProjectId, String btContent) throws SQLException {
		Connection con = null;
		PreparedStatement pstmt = null;
		try {
			con = DBUtil.getConnection();
